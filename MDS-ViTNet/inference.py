...
def init_models(args):
    path_to_ViT_multidecoder = "/home/pod/shared-nvme/AI4VA/MDS-ViTNet/checkpoints/best_model_200_2_0.5_1e-4_40.pth"
    # path_to_ViT_multidecoder = "./weights/ViT_multidecoder.pth"
    path_to_CNNMerge = "./weights/CNNMerge.pth"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--img_path", default="/home/pod/shared-nvme/AI4VA/data/images/test/", type=str, help="Path to directory containing images")
    parser.add_argument("--output_dir", default="/home/pod/shared-nvme/AI4VA/results/MDS_test_trained200_0.5_2_1e-4_40", type=str, help="Path to save output images")
