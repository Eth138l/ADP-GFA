...
def main(p, path_to_save):
    # Paths
    path_images_train = '../data/images/train/'
    path_images_val = '../data/images/val/'
    path_images_test = '../data/images/test/'

    path_maps_train = '../data/maps/train/'
    path_maps_val = '../data/maps/val/'

    path_train_ids = '../data/train_id.csv'
    path_val_ids = '../data/val_id.csv'
